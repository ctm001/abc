        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              const Expanded(
                child: Center(child: _ComingSoon(title: 'Bokstavlyder')),
              ),
            ],
          ),
        ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: AppColors.alphabeticPrinciple.withValues(alpha: 0.15),
            blurRadius: 12,
            offset: const Offset(0, 4),
          ),
        ],
      ...
      child: Column(
        ...
        children: [
          Icon(
            ...
            size: 64,
            color: AppColors.alphabeticPrinciple.withValues(alpha: 0.6),
          ),
